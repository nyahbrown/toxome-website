...
import GeolocationPanel from "@/components/admin/GeolocationPanel";

// Geolocation dashboard, on its own route so it is separate from the product
        ...
        <div style={{ textAlign: "center", maxWidth: 380 }}>
          ...
          >
            {user
              ...
              : "Sign in on the Admin page to view geolocation."}
          </p>
          <Link
            href="/admin"
            style={{
