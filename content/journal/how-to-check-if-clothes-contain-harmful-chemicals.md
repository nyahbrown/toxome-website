---
title: "How to Check If Your Clothes Contain Harmful Chemicals"
dek: "You can't see the chemicals in a new top, but the garment tells you more than you think. A practical, five-step way to check if your clothes contain harmful chemicals, straight from the label."
slug: "how-to-check-if-clothes-contain-harmful-chemicals"
date: "2026-07-06"
pillar: "Fabric Science"
mode: "educational"
hero: "/journal/how-to-check-if-clothes-contain-harmful-chemicals.jpg"
heroAlt: "Close-up of a striped knit garment with its sewn-in fabric tag turned out at the neckline, printed sizing visible, against a soft warm neutral ground."
heroCredit: "Photo: Atlantic Ambience via Pexels (pexels.com/photo/close-up-of-a-clothing-tag-12960395)"
caption: "The small tag on the inside seam is the most honest paragraph a garment will ever give you."
keywords:
  - "how to check if your clothes contain harmful chemicals"
  - "harmful chemicals in clothing"
...
cta: "app"
sources:
  - label: "U.S. Government Accountability Office. (2010). Formaldehyde in Textiles: While Levels in Clothing Generally Appear to Be Low, Allergic Contact Dermatitis Is a Health Issue for Some People. GAO-10-875."
    href: "https://www.gao.gov/products/gao-10-875"
  - label: "European Chemicals Agency (ECHA). REACH Regulation Annex XVII, Entry 43: Azo dyes and azo colourants that release listed aromatic amines."
    href: "https://echa.europa.eu/substances-restricted-under-reach"
  - label: "U.S. EPA. (2024). Our Current Understanding of the Human Health and Environmental Effects of PFAS."
    href: "https://www.epa.gov/pfas/our-current-understanding-human-health-and-environmental-effects-pfas"
  - label: "OEKO-TEX. STANDARD 100: Tested for harmful substances (over 1,000 substances, four product classes by skin contact)."
    href: "https://www.oeko-tex.com/en/our-standards/oeko-tex-standard-100/"
  - label: "Global Organic Textile Standard (GOTS). The Standard: ecological and social criteria for organic fibers and processing."
    href: "https://global-standard.org/the-standard"
  - label: "California AB 1817. (2022, effective 2025). Product safety: textile articles: perfluoroalkyl and polyfluoroalkyl substances."
    href: "https://leginfo.legislature.ca.gov/faces/billTextClient.xhtml?bill_id=202120220AB1817"
---
...
<figure class="j-figure j-figure--phone">
  <video src="/journal/how-to-check-if-clothes-contain-harmful-chemicals-step1.mp4" poster="/journal/how-to-check-if-clothes-contain-harmful-chemicals-step1.jpg" autoplay muted loop playsinline preload="auto"></video>
  <figcaption>Scanning a composition tag in the Toxome app. This top is 40% recycled polyester, which is still plastic against the skin.</figcaption>
</figure>
...
Not every seal is worth the thread it is printed on, and some are pure marketing. We sorted the ones that hold up from the ones that do not in the [Toxome certification guide](/guide/certifications).

<figure class="j-figure">
  <img src="/journal/how-to-check-if-clothes-contain-harmful-chemicals-cert.jpg" alt="The Toxome certification guide, with OEKO-TEX Standard 100, GOTS, and bluesign featured above a grid of textile certification seals." />
  <figcaption>The Toxome certification guide: which seals hold up, and what each one does and does not promise.</figcaption>
</figure>
...
<figure class="j-figure">
  <img src="/journal/how-to-check-if-clothes-contain-harmful-chemicals-closet.jpg" alt="The Toxome account dashboard: a closet score of 72 across scanned items, with cleaner alternatives and a row of recent scans." />
  <figcaption>Your Closet Score: your whole wardrobe scored in one number, with cleaner swaps for whatever ranks worst.</figcaption>
</figure>

<div class="j-cta">
  <p class="j-cta__eyebrow">Your closet</p>
  <p class="j-cta__headline">Do a Closet Detox.</p>
  <p class="j-cta__body">Scan the pieces you already own and Toxome gives you a Closet Score, one number for how clean your wardrobe runs, plus cleaner swaps for whatever ranks worst.</p>
  <a class="pill-cta" href="/account">Get your Closet Score</a>
</div>

The clothes you wear are a health choice, the same way food is, and for too long nobody gave you the information to make it. Reading the label is where it starts. And when you would rather not decode a tag in a fitting room, you can point a camera at the composition label and let it read the fibers and finishes for you, so the answer arrives before the garment ever touches your skin. Either way, the goal is the same. Know what's in your clothes, then choose on purpose.
